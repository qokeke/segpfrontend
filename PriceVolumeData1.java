...
public class PriceVolumeData1 extends ApplicationFrame {

    public PriceVolumeData1(String title) {
    ...
    private static JFreeChart createChart() {
        ...
        String title = "Financial TImes Stock Exchange 100";
        ...
        renderer1.setToolTipGenerator(
            new StandardXYToolTipGenerator(
                StandardXYToolTipGenerator.DEFAULT_TOOL_TIP_FORMAT,             //DEFAULT CASE, do not change
                new SimpleDateFormat("d-MMM-yyyy"), new DecimalFormat("0.00")   //TODO : Change X axis parameter from DateFormat to Time
            )
        );
        ...
        renderer2.setToolTipGenerator(
            new StandardXYToolTipGenerator(
                StandardXYToolTipGenerator.DEFAULT_TOOL_TIP_FORMAT,                    //DEFAULT CASE, do not change
                new SimpleDateFormat("d-MMM-yyyy"), new DecimalFormat("0,000.00")      //TODO : Change X axis parameter from Date Format to Time
            )
        );
     ...
     *
     */
    private static XYDataset createPriceDataset() {                             //TODO : Change parameter to take from the Hashmap
    ...
    public static void main(String[] args) {
        ...
        PriceVolumeData1 demo = new PriceVolumeData1("FTSE Analysis DEMO");
        demo.pack();
    ...
    //TODO : auto-update graph. Researching at the moment.
